...
| Event | Data fields | Trigger |
|-------|------------|---------|
| `keymap_hide` | name, buf, mode(T/n) | Hide keymap executed |
| `keymap_close` | name, buf, mode(T/n) | Close keymap executed |
| `keymap_toggle_fullscreen` | name, buf, mode(T/n/i/v) | Fullscreen toggle keymap |
